...
//	    String keyContent ="37d5aed075525d4fa0fe635231cba447";
//		DESEncryptUtil.test(keyFilePath, keyContent, operatorType);

		/** 加密 */
//		operatorType = "encrypt";
		String sourceFilePath = "D:/config.properties";
		DESEncryptUtil.test(keyFilePath, sourceFilePath, "encrypt");

        /** 解密 */
//		operatorType = "decrypt";
//		sourceFilePath = "D:/en_config.properties";
//		DESEncryptUtil.test(keyFilePath, sourceFilePath, operatorType);
	 ...
	 */
	public static Key createKey(String keycontent) throws NoSuchAlgorithmException, InvalidKeyException, InvalidKeySpecException
	{
		...
		DESKeySpec keySpec = new DESKeySpec(keycontent.getBytes());
	...
	public static InputStream doDecrypt(Key key, InputStream in)
	{
		try
		{
			...
			//            String p=new String(bout.toByteArray());
	...
	private static void test(String keyFilePath, String sourceFilePath,
		...
		{
			// 生成密钥文件
			Key key = DESEncryptUtil.createKey(sourceFilePath);
