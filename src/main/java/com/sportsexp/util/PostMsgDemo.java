...
//			if (msg.post("13319516082","鹰皇测试短信456", null) == 0){
...
//			}
			...
			msgData[0] = new MessageData("13319516082", "1");
			msgData[1] = new MessageData("321332", "2");
			msgData[2] = new MessageData("18692242266", "3");
			System.out.println("发送状态:"+msg.post(msgData, null));				
			System.out.println("余额为：" + remainFee + "分");				
